...
- Regular users should be able to reserve seats for a showtime.
  ...
  <i>"You can create the initial admin using seed data. Only admins should be able to promote other users to admin and
  be able to do things related to movie management, reporting, etc."</i>
